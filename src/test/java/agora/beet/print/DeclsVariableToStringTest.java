...
public class DeclsVariableToStringTest {
    ...
    public void testPrintDeclsVariableWithoutEnclosingVar() {
        ...
        DeclsVariable declsVariable1 = new DeclsVariable("variableName", "varKind", "int", "double", null);
        String[] declsVariable1Lines = declsVariable1.toString().split("\n");

        assertFalse(declsVariable1.isArray());
        assertEquals("Incorrect variable name line", "variable variableName", declsVariable1Lines[0]);
    ...
    public void testPrintDeclsVariableWithEnclosingVar() {
        // With enclosing var
        DeclsVariable declsVariable2 = new DeclsVariable("variableName", "varKind", "int", "double", "enclosingVar");
        String[] declsVariable2Lines = declsVariable2.toString().split("\n");

        assertFalse(declsVariable2.isArray());
        assertEquals("Incorrect variable name line", "variable variableName", declsVariable2Lines[0]);
    ...
    public void testPrintDeclsVariableIsArrayTrue() {
        // isArray = true
        DeclsVariable declsVariable = new DeclsVariable("variableName", "varKind", "int", "double", "enclosingVar", true);
        String[] declsVariableLines = declsVariable.toString().split("\n");

        assertTrue(declsVariable.isArray());

        assertEquals("Incorrect variable name line", "variable variableName", declsVariableLines[0]);
    ...
    public void testPrintDeclsVariableTypeArray() {
        // varKind = array
        DeclsVariable declsVariable = new DeclsVariable("variableName", "array", "int", "double", "enclosingVar");
        String[] declsVariableLines = declsVariable.toString().split("\n");
    ...
    public void testPrintDeclsVariableWithASon() {
        // With a son
        DeclsVariable father = new DeclsVariable("variableNameFather", "varKindFather", "int", "double", null);
        DeclsVariable son = new DeclsVariable("variableNameSon", "varKindSon", "int", "double", "variableNameFather");
        ...
        assertEquals("Incorrect dec-type line", "variable variableNameSon", declsVariableLines[4]);
