...
//                assertEquals("The size of the list of exit variables is not 1", 1, declsExit.getExitDeclsVariables().size());
                ...
                assertEquals("Incorrect decType", packageName + ".findByAddress"+ HIERARCHY_SEPARATOR +"Input", enterDeclsFatherVariable.getDecType());
                ...
                assertEquals("Incorrect decType", packageName + ".findByAddress"+HIERARCHY_SEPARATOR+"Output"+HIERARCHY_SEPARATOR+"200", exitDeclsFatherVariable.getDecType());
