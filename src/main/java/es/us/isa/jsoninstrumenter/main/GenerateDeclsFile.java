...
public class GenerateDeclsFile {
    ...
    private static String testCasesFilePath = "src/test/resources/dtraceOracles/exit/exitOfTypeArray/withoutNesting/nullValues/nullArray/testCase_exitOfTypeArray_nullArray.csv";
